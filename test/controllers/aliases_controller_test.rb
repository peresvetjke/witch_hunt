...
class AliasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alias" do
    assert_difference("Alias.count") do
      post aliases_url, params: { alias: { entity_id: @alias.entity_id, title: @alias.title } }
    end
  ...
  test "should update alias" do
    patch alias_url(@alias), params: { alias: { entity_id: @alias.entity_id, title: @alias.title } }
