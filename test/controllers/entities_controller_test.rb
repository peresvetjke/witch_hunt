...
class EntitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create entity" do
    assert_difference("Entity.count") do
      post entities_url, params: { entity: { title: @entity.title, type_id: @entity.type_id } }
    end
  ...
  test "should update entity" do
    patch entity_url(@entity), params: { entity: { title: @entity.title, type_id: @entity.type_id } }
